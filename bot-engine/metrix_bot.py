...
def process_lead(result, location, is_premium):
    ...
    if reviews == 0 or (3.0 <= rating <= 4.3) or reviews < 50:
        ...
        if result.get("place_id"):
            ...
            demo_url = f"https://metrixmedia.vercel.app/demo.html?name={encoded_name}&theme=dark&url={encoded_maps}"
        else:
            demo_url = f"https://metrixmedia.vercel.app/demo.html?name={encoded_name}&theme=dark"
